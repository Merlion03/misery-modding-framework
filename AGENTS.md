...
Мы находимся только на **Phase 1 — Research**.

Сейчас НЕ нужно создавать production Mod Loader, готовый Bootstrap, публичный SDK или полноценный `MiseryRuntime.dll`.

Наша задача — системно исследовать установленную игру MISERY и подготовить фундамент, на котором позднее можно будет построить собственную modding platform без зависимости от UE4SS.
...
* строй production loader сейчас;
